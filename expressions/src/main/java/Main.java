public class Main {
    public static void main(String[] args) {
        ...
        // Same thing here - fractional part is discarded.
        ...
        // Looking at `Math.pow()`'s method signature, we can see that it returns a double, so we append the 'd' prefix.
        ...
        // You may notice that we lose a few decimal digits here. That's because our calculation of sin(45 radians) is
        // a bit less accurate than that of the computer. Hope that's fine!
